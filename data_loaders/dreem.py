...
class DreemDataset(data.Dataset):
    def __init__(self, file_path,transform={},training=True):
...
class DreemDataLoader(BaseDataLoader):
    ...
    """
    def __init__(self, data_dir, batch_size, shuffle=True, validation_split=0.0, num_workers=1, training=True,transform={}):
